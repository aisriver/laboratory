    ...
    children: [
      {
        ...
        type: 'line-simple&theme',
        src:
          'https://cdn.jsdelivr.net/gh/apache/echarts-website@asf-site/examples/data/thumb-dark/line-simple.webp?_v_=1612615474746',
      },
      {
        title: '基础平滑折线图',
        subtitle: 'Smoothed Line Chart',
        type: 'line-smooth&theme',
        src:
          'https://cdn.jsdelivr.net/gh/apache/echarts-website@asf-site/examples/data/thumb-dark/line-smooth.webp?_v_=1612615474746',
      },
      {
        title: '基础面积图',
        subtitle: 'Basic area chart',
        type: 'area-basic&theme',
        src:
          'https://cdn.jsdelivr.net/gh/apache/echarts-website@asf-site/examples/data/thumb-dark/area-basic.webp?_v_=1612615474746',
      },
      {
        title: '折线图堆叠',
        subtitle: 'Stacked Line Chart',
        type: 'line-stack&theme',
        src:
          'https://cdn.jsdelivr.net/gh/apache/echarts-website@asf-site/examples/data/thumb-dark/line-stack.webp?_v_=1612615474746',
      },
      {
        title: '堆叠面积图',
        subtitle: 'Stacked area chart',
        type: 'area-stack&theme',
        src:
      ...
      },
      {
        ...
        type: 'area-stack-gradient&theme',
        src:
      ...
      },
      {
        ...
        type: 'data-transform-filter&theme',
        src:
      ...
      },
      {
        ...
        type: 'line-in-cartesian-coordinate-system&theme',
        src:
      ...
      },
      {
        ...
        type: 'line-draggable&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '极坐标双数值轴',
        subtitle: 'Two Value-Axes in Polar',
        type: 'line-polar&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '极坐标双数值轴',
        subtitle: 'Two Value-Axes in Polar',
        type: 'line-polar2&theme',
        src:
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        type: 'bar-y-category-stack&theme',
        src:
      ...
      },
      {
        ...
        type: 'bar-animation-delay&theme',
        src:
      ...
      // 	type: 'mix-timeline-finance&theme',
      // 	src:
      ...
      // },
      {
        ...
        type: 'bar-polar-real-estate&theme',
        src:
      ...
      },
      {
        ...
        type: 'bar-polar-stack-radial&theme',
        src:
      ...
      },
      {
        ...
        type: 'data-transform-sort-bar&theme',
        src:
      ...
      },
      {
        ...
        type: 'dataset-series-layout-by&theme',
        src:
    ...
    children: [
      {
        ...
        type: 'pie-simple&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '圆角环形图',
        subtitle: 'Doughnut Chart with Rounded Corner',
        type: 'pie-borderRadius&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '环形图',
        subtitle: 'Doughnut Chart',
        type: 'pie-doughnut&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '饼图自定义样式',
        subtitle: 'Customized Pie',
        type: 'pie-custom&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '饼图纹理',
        subtitle: 'Texture on Pie Chart',
        type: 'pie-pattern&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      // {
      // 	title: '南丁格尔玫瑰图',
      // 	subtitle: "Nightingale's Rose Diagram",
      // 	type: 'pie-roseType&theme',
      // 	src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      // },
      {
        title: '基础南丁格尔玫瑰图',
        subtitle: "Nightingale's Rose Diagram",
        type: 'pie-roseType-simple&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      // {
      // 	title: '饼图标签对齐',
      // 	subtitle: 'Pie Label Align',
      // 	type: 'pie-alignTo&theme',
      // 	src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      // },
      // {
      // 	title: '饼图引导线调整',
      // 	subtitle: 'Label Line Adjust',
      // 	type: 'pie-labelLine-adjust&theme',
      // 	src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      // },
      {
        title: '可滚动的图例',
        subtitle: 'Pie with Scrollable Legend',
        type: 'pie-legend&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '富文本标签',
        subtitle: 'Pie Special Label',
        type: 'pie-rich-text&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '嵌套环形图',
      ...
      },
      {
        ...
        type: 'data-transform-multiple-pie&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      // {
      // 	title: '默认 encode 设置',
      // 	subtitle: 'Default arrangement',
      // 	type: 'dataset-default&theme',
      // 	src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      // },
      // {
      // 	title: '日历饼图',
      // 	subtitle: 'Calendar Pie',
      // 	type: 'calendar-pie&theme',
      // 	src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      // },
      // {
      // 	title: '联动和共享数据集',
    ...
    children: [
      {
        ...
        type: 'scatter-simple&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      // {
      // 	title: "Anscomb's quartet",
      // 	subtitle: "Anscomb's quartet",
      // 	type: 'scatter-anscombe-quartet&theme',
      // 	src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      // },
      {
        title: '数据聚合',
        subtitle: 'Clustering Process',
        type: 'scatter-clustering&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '聚合过程可视化',
        subtitle: 'Clustering Process',
        type: 'scatter-clustering-process&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '指数回归（使用统计插件）',
        subtitle: 'Exponential Regression',
        type: 'scatter-exponential-regression&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '涟漪特效散点图',
        subtitle: 'Effect Scatter Chart',
        type: 'scatter-effect&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '线性回归（使用统计插件）',
        subtitle: 'Linear Regression',
        type: 'scatter-linear-regression&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '多项式回归（使用统计插件）',
        subtitle: 'Polynomial Regression',
        type: 'scatter-polynomial-regression&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: 'GitHub 打卡气泡图',
        subtitle: 'Punch Card of Github',
        type: 'scatter-punchCard&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '单轴散点图',
        subtitle: 'Scatter on Single Axis',
        type: 'scatter-single-axis&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '男性女性身高体重分布',
        subtitle: 'Distribution of Height and Weight',
        type: 'scatter-weight&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '散点图标签顶部对齐',
        subtitle: 'Align Label on the Top',
        type: 'scatter-label-align-right&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '散点图标签顶部对齐',
        subtitle: 'Align Label on the Top',
        type: 'scatter-label-align-top&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '大规模散点图',
        subtitle: 'Large Scatter',
        type: 'scatter-large&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '大规模星云散点图',
        subtitle: 'Scatter Nebula',
        type: 'scatter-nebula&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '流式渲染和视觉映射操作',
        subtitle: 'Visual interaction with stream',
        type: 'scatter-stream-visual&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '气泡图',
        subtitle: 'Bubble Chart',
        type: 'bubble-gradient&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: 'AQI 气泡图',
        subtitle: 'Scatter Aqi Color',
        type: 'scatter-aqi-color&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '营养分布散点图',
        subtitle: 'Scatter Nutrients',
        type: 'scatter-nutrients&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '营养分布散点矩阵',
        subtitle: 'Scatter Nutrients Matrix',
        type: 'scatter-nutrients-matrix&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: 'GitHub 打卡气泡图（极坐标）',
        subtitle: 'Punch Card of Github',
        type: 'scatter-polar-punchCard&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '各国人均寿命与GDP关系演变',
        subtitle: 'Life Expectancy and GDP',
        type: 'scatter-life-expectancy-timeline&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: 'Master Painter Color Choices Throughout History',
        subtitle: 'Master Painter Color Choices Throughout History',
        type: 'scatter-painter-choice&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '全国主要城市空气质量 - 百度地图',
        subtitle: 'Air Quality - Baidu Map',
        type: 'effectScatter-bmap&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '对数回归（使用统计插件）',
        subtitle: 'Logarithmic Regression',
        type: 'scatter-logarithmic-regression&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      // {
      // 	title: '散点矩阵和平行坐标',
      // 	subtitle: 'Scatter Matrix',
      // 	type: 'scatter-matrix&theme',
      // 	src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      // },
      {
        title: '日力图',
        subtitle: 'Calendar Charts',
        type: 'calendar-charts&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
    ],
  },
    ...
    children: [
      {
        ...
        type: 'candlestick-simple&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: 'OHLC 图（使用自定义系列）',
        subtitle: 'OHLC Chart',
        type: 'custom-ohlc&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '上证指数',
        subtitle: 'ShangHai Index',
        type: 'candlestick-sh&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '大数据量K线图',
        subtitle: 'Large Scale Candlestick',
        type: 'candlestick-large&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '触屏上的坐标轴指示器',
        subtitle: 'Axis Pointer Link and Touch',
        type: 'candlestick-touch&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '日力图刷选',
        subtitle: 'Candlestick Brush',
        type: 'candlestick-brush&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '2015 年上证指数',
        subtitle: 'ShangHai Index, 2015',
        type: 'candlestick-sh-2015&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        type: 'radar-aqi&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '自定义雷达图',
        subtitle: 'Customized Radar Chart',
        type: 'radar-custom&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '浏览器占比变化',
    ...
    children: [
      {
        ...
        type: 'data-transform-aggregate&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '基础盒须图',
        subtitle: 'Boxplot Light Velocity',
        type: 'boxplot-light-velocity&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '垂直方向盒须图',
        subtitle: 'Boxplot Light Velocity2',
        type: 'boxplot-light-velocity2&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '多系列盒须图',
        subtitle: 'Multiple Categories',
        type: 'boxplot-multi&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
    ],
  },
    ...
    children: [
      {
        ...
        type: 'heatmap-cartesian&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '热力图 - 2w 数据',
        subtitle: 'Heatmap - 2w data',
        type: 'heatmap-large&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '热力图 - 颜色的离散映射',
        subtitle: 'Heatmap - Discrete Mapping of Color',
        type: 'heatmap-large-piecewise&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '热力图与百度地图扩展',
        subtitle: 'Heatmap on Baidu Map Extension',
        type: 'heatmap-bmap&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '日历热力图',
        subtitle: 'Calendar Heatmap',
        type: 'calendar-heatmap&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '纵向日历图',
        subtitle: 'Calendar Heatmap Vertical',
        type: 'calendar-vertical&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
    ],
  },
    ...
    children: [
      {
        ...
        type: 'graph-force2&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '笛卡尔坐标系上的 Graph',
        subtitle: 'Graph on Cartesian',
        type: 'graph-grid&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: 'Graph 简单示例',
        subtitle: 'Simple Graph',
        type: 'graph-simple&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '力引导布局',
        subtitle: 'Force Layout',
        type: 'graph-force&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '关系图自动隐藏重叠标签',
        subtitle: 'Hide Overlapped Label',
        type: 'graph-label-overlap&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '悲惨世界人物关系图',
    ...
    children: [
      {
        ...
        type: 'tree-basic&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '多棵树',
        subtitle: 'Multiple Trees',
        type: 'tree-legend&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '从下到上树状图',
        subtitle: 'From Bottom to Top Tree',
        type: 'tree-orient-bottom-top&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '从右到左树状图',
        subtitle: 'From Right to Left Tree',
        type: 'tree-orient-right-left&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '折线树图',
        subtitle: 'Tree with Polyline Edge',
        type: 'tree-polyline&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '径向树状图',
        subtitle: 'Radial Tree',
        type: 'tree-radial&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '从上到下树状图',
        subtitle: 'From Top to Bottom Tree',
        type: 'tree-vertical&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
    ],
  },
    ...
    children: [
      {
        ...
        type: 'sunburst-simple&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '圆角旭日图',
        subtitle: 'Sunburst with Rounded Corner',
        type: 'sunburst-borderRadius&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '旭日图标签旋转',
        subtitle: 'Sunburst Label Rotate',
        type: 'sunburst-label-rotate&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: 'Monochrome Sunburst',
        subtitle: 'Monochrome Sunburst',
        type: 'sunburst-monochrome&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '旭日图使用视觉编码',
        subtitle: 'Sunburst VisualMap',
        type: 'sunburst-visualMap&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: 'Drink Flavors',
        subtitle: 'Drink Flavors',
        type: 'sunburst-drink&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '书籍分布',
        subtitle: 'Book Records',
        type: 'sunburst-book&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
    ],
  },
    ...
    children: [
      {
        ...
        type: 'parallel-simple&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: 'AQI 分布（平行坐标）',
        subtitle: 'Parallel Aqi',
        type: 'parallel-aqi&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '营养结构（平行坐标）',
        subtitle: 'Parallel Nutrients',
        type: 'parallel-nutrients&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      // {
      // 	title: '散点矩阵和平行坐标',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        type: 'funnel-align&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '漏斗图',
        subtitle: 'Customized Funnel',
        type: 'funnel-customize&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '漏斗图',
        subtitle: 'Multiple Funnels',
        type: 'funnel-mutiple&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        type: 'gauge-simple&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '速度仪表盘',
        subtitle: 'Speed Gauge',
        type: 'gauge-speed&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '进度仪表盘',
        subtitle: 'Grogress Gauge',
        type: 'gauge-progress&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '阶段速度仪表盘',
        subtitle: 'Stage Speed Gauge',
        type: 'gauge-stage&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '等级仪表盘',
        subtitle: 'Grade Gauge',
        type: 'gauge-grade&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '多标题仪表盘',
        subtitle: 'Multi Title Gauge',
        type: 'gauge-multi-title&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '气温仪表盘',
        subtitle: 'Temperature Gauge chart',
        type: 'gauge-temperature&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '得分环',
        subtitle: 'Ring Gauge',
        type: 'gauge-ring&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '气压表',
        subtitle: 'Gauge Barometer chart',
        type: 'gauge-barometer&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '时钟仪表盘',
        subtitle: 'Clock Gauge',
        type: 'gauge-clock&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: 'Gauge Car',
        subtitle: 'Gauge Car',
        type: 'gauge-car&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
    ],
  },
    ...
    children: [
      {
        ...
        type: 'pictorialBar-body-fill&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      // {
      // 	title: '虚线柱状图效果',
      // 	subtitle: 'Dotted bar',
      // 	type: 'pictorialBar-dotted&theme',
      // 	src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      // },
      {
        title: '森林的增长',
        subtitle: 'Expansion of forest',
        type: 'pictorialBar-forest&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '圣诞愿望清单和山峰高度',
        subtitle: 'Wish List and Mountain Height',
        type: 'pictorialBar-hill&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '精灵',
        subtitle: 'Spirits',
        type: 'pictorialBar-spirit&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '交通工具',
        subtitle: 'Vehicles',
        type: 'pictorialBar-vehicle&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '驯鹿的速度',
        subtitle: 'Velocity of Christmas Reindeers',
        type: 'pictorialBar-velocity&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
    ],
  },
    ...
    children: [
      {
        title: '主题河流图',
        subtitle: 'ThemeRiver',
        type: 'themeRiver-basic&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: 'ThemeRiver Lastfm',
        subtitle: 'ThemeRiver Lastfm',
        type: 'themeRiver-lastfm&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        type: 'calendar-horizontal&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '日历关系图',
      ...
      },
      {
        ...
        type: 'custom-calendar-icon&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
    ],
  },
    ...
    children: [
      {
        ...
        type: 'bar-histogram&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '利润分布直方图',
        subtitle: 'Profit',
        type: 'custom-profit&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '使用自定系列给散点图添加误差范围',
        subtitle: 'Error Scatter on Catesian',
        type: 'custom-error-scatter&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '使用自定义系列添加柱状图趋势',
        subtitle: 'Custom Bar Trend',
        type: 'custom-bar-trend&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '自定义多边形图',
        subtitle: 'Custom Cartesian Polygon',
        type: 'custom-cartesian-polygon&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '使用自定系列给柱状图添加误差范围',
        subtitle: 'Error Bar on Catesian',
        type: 'custom-error-bar&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '性能分析图',
        subtitle: 'Profile',
        type: 'custom-profile&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: 'Cycle Plot',
        subtitle: 'Cycle Plot',
        type: 'cycle-plot&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '机场航班甘特图',
        subtitle: 'Gantt Chart of Airport Flights',
        type: 'custom-gantt-flight&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '极坐标热力图（自定义系列）',
        subtitle: 'Polar Heatmap',
        type: 'custom-polar-heatmap&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '风向图',
        subtitle: 'Wind Barb',
        type: 'wind-barb&theme',
        src: 'https://echarts.apache.org/examples/asset/placeholder.jpg',
      },
      {
        title: '六边形分箱图（自定义系列）',
